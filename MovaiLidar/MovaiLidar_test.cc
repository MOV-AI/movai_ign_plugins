...
#include "test/MockSystem.hh"
#include "test/EnvTestFixture.hh"
...
/// \brief Test MovaiLidarTest system
class MovaiLidarTest : public InternalFixture<::testing::Test>
{};
...
TEST_F(MovaiLidarTest, IGN_UTILS_TEST_DISABLED_ON_MAC(MovaiLidarBox))
{
  const int horzSamples = 2048;

  // Start server
  ServerConfig serverConfig;
  const auto sdfFile = "movai_ign_plugins/system/test/movai_lidar_test.sdf";
